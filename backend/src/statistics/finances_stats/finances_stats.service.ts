...
import { PeriodFilterDto, PeriodFilter } from '../analytics/dto/period-filter.dto';
...
export class FinancesStatsService {
  ...
  async getCrmAnalysis(user: User, periodFilterDto: PeriodFilterDto) {
    ...
    const wonCount = opportunities.filter(o => o.stage === OpportunityStage.WON).length;
