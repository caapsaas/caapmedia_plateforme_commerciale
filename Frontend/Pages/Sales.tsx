                                        ...
                                        <tr key={order.id} className="bg-white border-b hover:bg-slate-50">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                {order.status === OrderStatus.PENDING_VALIDATION ? (
                                                     <button onClick={() => onValidateForProduction(order.id)} className="flex items-center mx-auto space-x-2 px-3 py-1 bg-green-500 text-white text-xs font-semibold rounded-md hover:bg-green-600 transition-colors" title={t('sales.validateForProduction')}>
