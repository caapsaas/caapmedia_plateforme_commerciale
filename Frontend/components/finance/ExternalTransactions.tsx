...
import { ExternalFinancialTransaction, ExternalTransactionType, ExternalTransactionCategory, ExternalTransactionStatus, PaymentMethod, Subsidiary } from '../../types/models';
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          ...
          <div className="flex gap-2">
            ...
            >
              {t('externalTransactions.actions.exportCSV')}
            </button>
            <button
              onClick={handleExportPDF}
              className="px-4 py-2 bg-[#c6e911] text-white rounded-md hover:bg-[#a8d814] focus:outline-none focus:ring-2 focus:ring-[#c6e911] transition-colors font-medium shadow-sm"
              disabled={transactions.length === 0}
            >
              {t('externalTransactions.actions.exportPDF')}
            </button>
          </div>
        </div>
      </div>
                ...
                <tr key={transaction.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex items-center space-x-2">
                      ...
                      {transaction.status !== ExternalTransactionStatus.VALIDATED && (
                        <button
          ...
          <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
              <button
                ...
                className="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors font-medium"
              >
                {t('common.cancel')}
              </button>
              <button
                onClick={showCreateModal ? handleCreate : handleUpdate}
                className="px-6 py-2 bg-[#c6e911] text-white rounded-lg hover:bg-[#a8d814] focus:outline-none focus:ring-2 focus:ring-[#c6e911] transition-colors font-medium shadow-sm"
              >
