import { api } from '.././api';
import { ProductionStatus, CustomerPaymentMethod, OrderStatus, PaymentStatus } from '../../types';
 ...
 */
export const updateProductionStatus = async (payload: { orderId: string; status: ProductionStatus }) => {
